...
#If There are Exactly Three Beacons...
elif(int(n) == 3):

    #Change Text Color to Teal
    print("\033[35m")
    
    #Ask for Input of Distance Between Device and Beacons
    d1 = input("Beacon 1: ")
    d2 = input("Beacon 2: ")
    d3 = input("Beacon 3: ")

    #Assign the Position of The Beacons Based on the Order of Input
    x1, y1 = b[1]
    x2, y2 = b[2]
    x3, y3 = b[3]

    #Assigning Variables to Segments of Formula
    A = 2*x2 - 2*x1
    B = 2*y2 - 2*y1
    ...
    #Calculate the Angle Between the Current Point and Destination
...
#If There are More than Three Beacons...
else:
